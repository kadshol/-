        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-xl text-slate-600 leading-relaxed font-medium">
              ...
              <p>
                בפעוטון סאנשיין, אנו משלבים את עקרונות המונטסורי המעודדים עצמאות, למידה חווייתית ובחירה חופשית, לצד דגש עצום על אינטליגנציה רגשית – כי ילד שמרגיש בטוח ואהוב הוא ילד פנוי ללמוד.
              </p>
            </div>
